# Modelo de Revisão de Gestão — ISO 9001 + 14001 + 45001
...
- Mudanças internas/externas que afetem o SGI (contexto, riscos e oportunidades)
- Conformidade legal e outros requisitos aplicáveis (ambiental e SSO)
...
- Atualizações de políticas, objetivos e metas
...
- Recursos: equipe, dados, infraestrutura de reunião
- Controles: calendário, procedimento, checklist, registros
...
- [ ] Ata preenchida e aprovada
- [ ] Plano de ações com responsáveis, prazos e status
- [ ] KPIs atualizados e metas revisadas
...
- Necessidades de recursos e riscos
...
Este documento pode ser consumido via /api/docs e /api/search-docs e usado pelo módulo UI em Operações > Revisão de Gestão.